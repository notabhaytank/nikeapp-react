...
function Hero(props) {
    ...
    return (
        <section id="home" className="w-full  p-2 flex flex-wrap xl:flex-row justify-center min-h-screen gap-10 max-container  ">
            ...
            <div className="relative flex    justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center" >
                <img
                    src={bigShoeImg}
                    alt="img"
                    className="object-contain relative z-10 " width={610} height={500}/>
